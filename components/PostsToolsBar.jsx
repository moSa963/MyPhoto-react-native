...
const ToolsBar = ({ onChange }) => {
    ...
    return (
        <View style={styles.root} >
            <Animated.View onLayout={(e) => setLayout(e.nativeEvent.layout)}
                ...
                <View style={{ width: '100%', height: '100%', flexDirection: 'row', opacity: collapsed ? 0 : 1 }}>
                    ...
                    <TouchableOpacity style={{ ...styles.itemCont }}
                        ...
                        <MaterialIcons name="history" color={theme.colors.text} size={20} />
                ...
                </View>
                {
                    collapsed &&
                    <View style={{
                        width: '100%', height: '100%', position: 'absolute', flexDirection: 'row', backgroundColor: theme.colors.background,
                        justifyContent: 'space-evenly',
                        alignItems: 'center',
                        opacity: collapsed ? 1 : 0
                    }}>
                        <TouchableOpacity style={{
                            ...styles.itemCont2, backgroundColor: position2 == 0 ? theme.colors.background : theme.colors.card,
                        ...
                        <TouchableOpacity style={{
                            ...styles.itemCont2, backgroundColor: position2 == 1 ? theme.colors.background : theme.colors.card,
                            width: layout.width / 4,
                            height: 40,
                            transform: [
                        ...
                        <TouchableOpacity style={{
                            ...styles.itemCont2, backgroundColor: position2 == 2 ? theme.colors.background : theme.colors.card,
                            width: layout.width / 4,
                            height: 40,
                            transform: [
            ...
            <TouchableOpacity style={{
                marginRight: 'auto', height: '100%', backgroundColor: theme.colors.background,
                alignItems: 'center', flexDirection: 'row'
            }} onPress={() => setCollapsed(!collapsed)}>
                <Ionicons name="ellipsis-vertical" color={theme.colors.text} size={25} />
            </TouchableOpacity>
        </View>
    )
}
